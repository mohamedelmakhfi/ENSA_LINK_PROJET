      ...
      <div className="w-full max-w-sm mx-auto overflow-hidden  rounded-md shadow-md">
        <div className="px-6 py-4">
          ...
          <form>
            ...
            <div className="flex items-center text-white justify-between mt-4">
              <Link to="/">
              ...
              <button
                ...
                className={` transform rounded-lg bg-sky-800 px-6 py-3 text-sm font-medium tracking-wide text-white transition-colors duration-300 hover:bg-cyan-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50 `}>
                {signingIn ? (
