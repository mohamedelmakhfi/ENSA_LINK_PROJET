...
const VerifyEmail = () => {
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto bg-gray-900 text-white">
        ...
        <div className="rounded-md bg-gray-800 p-6 shadow-md">
          ...
          <div className="mb-4">
            <input
              ...
              className="w-full rounded-lg border-2 border-gray-600 p-2 text-black"
              value={code}
          ...
          <button
            className="ml-4 rounded-lg bg-gray-700 px-4 py-2 text-gray-200 hover:bg-gray-600"
            onClick={() => {
              navigate("/signup");
            }}
          >
