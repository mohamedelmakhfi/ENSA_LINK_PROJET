...
const CommunityHome = () => {
  ...
  if (!joinedCommunities) {
    return (
      <div className="col-span-3 flex h-screen items-center justify-center bg-gray-900 text-white">
        <CommonLoading />
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className="col-span-1 h-[85vh] overflow-y-auto rounded-md border border-sky-300 bg-gray-900 p-5 md:sticky md:top-20">
        <CommunityRightbar />
      </div>
    </>
  );
