...
const LoadMoreButton = ({ onClick, isLoading }) => (
  <button
    className="bg-gray-800 hover:bg-gray-700 text-sm text-white font-semibold rounded-md w-full p-2 my-3"
    onClick={onClick}
    disabled={isLoading}
  >
...
const MainSection = ({ userData }) => {
  ...
  return (
    <>
      <div className="bg-gray-900 text-white">{memoizedPosts}</div>
      ...
      {posts.length === 0 && (
        <div className="text-center text-white flex justify-center items-center flex-col bg-gray-900">
