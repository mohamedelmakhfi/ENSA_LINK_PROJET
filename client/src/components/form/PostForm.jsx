...
const PostForm = ({ communityId, communityName }) => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="border-b bg-gray-900 p-6">
        <div className="mb-4">
          <label
            htmlFor="content"
          ...
          <textarea
            className="w-full resize-none rounded-md border p-2 bg-gray-800 text-white"
            name="content"
            id="content"
        ...
        <div className="mb-4">
          <label
            htmlFor="file"
            className="mx-auto mt-6 flex cursor-pointer items-center rounded-lg border-2 border-dashed bg-gray-800 px-3 py-3 text-center"
          >
            <svg
