...
const BannerMembersList = () => {
  ...
  const bannedUsers = useSelector((state) => state.moderation.bannedUsers) || [];
        ...
        {bannedUsers &&
          bannedUsers.map((bannedMember) => (
            <div
              ...
              className="flex flex-col border border-gray-700 bg-gray-800 px-6 py-3 my-3 rounded-lg "
            >
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="ml-2 text-xs flex gap-1 items-center text-gray-400">
                      <CiLocationOn />
