...
const Leftbar = ({ showLeftbar }) => {
  ...
  return (
    <div className={`${showLeftbar ? "" : "hidden"} leftbar bg-gray-900 text-white`}>
      <div className="flex flex-col justify-start items-center bg-gray-900">
              ...
              <ul className="w-full mt-3">
                {communityLinks.map((communityLink) => (
                  <li key={communityLink.href}>
                    <Link
                      className="flex items-center hover:text-primary text-gray-400 font-medium gap-2 py-1"
