...
const Rightbar = () => {
  ...
  return (
    <div className="hidden rightbar overflow-auto bg-gray-900 text-white">
        ...
        <div className="bg-gray-900">
          ...
          <ul className="flex flex-col gap-3">
            {visibleCommunities?.map((community) => (
              <li
                key={community._id}
                className="flex items-center justify-between bg-gray-800 px-2 py-1 rounded-md"
              >
      ...
      <ul className="flex flex-col gap-3">
        {recommendedUsers?.length > 0 &&
          recommendedUsers.map((user) => (
            <li
              key={user._id}
              className="flex justify-between items-center gap-5 bg-gray-800 border border-black px-2 py-1 rounded-lg"
            >
