    ...
    <div>
      <div className="relative">
        <input
          ...
          className="h-10 py-1 bg-gray-800 border border-gray-600 w-full md:w-[660px] rounded-full text-sm shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-500 transition duration-300 pl-3 pr-10 text-white"
          aria-label="Search"
          autoComplete="off"
        />
        {inputValue !== "" && (
      ...
      {inputValue !== "" && (
        <div
          ...
          className="absolute start-0 md:start-auto w-screen top-12 md:w-[660px] bg-gray-800 border rounded-md shadow-md"
        >
          {loading && (
              ...
              {posts.map((post) => (
                <li key={post._id} className="border-b py-2 px-4">
                  <div
                    ...
                    className="block text-sm text-white hover:text-blue-500 cursor-pointer"
                  >
              ...
              {users.map((user) => (
                <li key={user._id} className="border-b py-2 px-4">
                  <div
                    ...
                    className="block text-sm text-white hover:text-indigo-500 cursor-pointer"
                  >
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <img
          ...
          {joinedCommunity && (
            <div
              ...
              className="block text-sm text-white hover:text-indigo-500 border-b py-2 px-4 cursor-pointer"
            >
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <img
