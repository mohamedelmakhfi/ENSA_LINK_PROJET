...
const SavedPost = ({ post }) => {
  ...
  return (
    <div className="px-6 py-6 rounded-md border bg-gray-800 mb-6 w-full text-white">
      <p className="border border-dashed border-gray-600 cursor-pointer px-2 py-2 w-7 h-7 flex justify-center items-center mb-3 rounded-full">
        <IoIosArrowBack
