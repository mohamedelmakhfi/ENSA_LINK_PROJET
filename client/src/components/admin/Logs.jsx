...
const Logs = () => {
  ...
  if (loading || !logs) {
    return (
      <div className="flex items-center justify-center mt-5 bg-gray-900 text-white h-screen">
        <CommonLoading />
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-800 flex flex-col items-center justify-center mt-3 rounded-md">
      <div className="p-4 shadow-md rounded relative xl:min-w-[1200px] lg:min-w-[1000px] md:min-w-[800px]">
        ...
        <div className="flex justify-between items-center mb-4 border-b border-gray-700 pb-2">
          <div className="text-sm italic text-gray-400">{`Showing ${logs.length} items from the last 7 days`}</div>

          <div className="flex items-center space-x-2">
            <button onClick={handleRefresh}>
              <FcRefresh className="text-white" />
            </button>
            <button
            ...
            <>
              <div className="h-[430px] relative overflow-auto">
                <div className="w-full rounded">
                  <div className="grid grid-cols-5 gap-5 items-center border-b py-2 font-semibold text-gray-200">
                  ...
                  {logs.map((log) => (
                    <div
                      key={log._id}
                      className="grid grid-cols-5 gap-5 items-center border-b py-2 text-sm text-gray-300"
                    >
              ...
              <div className="flex justify-center text-sm italic text-gray-400 mt-2">
