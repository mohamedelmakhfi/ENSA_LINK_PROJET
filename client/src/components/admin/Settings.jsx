...
const Settings = () => {
  ...
  return (
    <div className="p-5 w-full border rounded-md bg-gray-800 mt-3 text-white">
      <h2 className="font-semibold mb-4 border-b pb-2 text-center">
        Service Preferences
      </h2>
      ...
      <div className="flex items-center mb-4">
        ...
        <div className="ml-auto">
          <input
            className="w-5 h-5 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-900"
            type="checkbox"
      ...
      <div className="flex items-center mb-4">
        ...
        <div className="ml-auto">
          <select
            className="bg-gray-700 border-gray-600 text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
