      ...
      <div className="my-4">
        {isModeratorOfThisCommunity && (
          <Link
            ...
            className="px-4 bg-primary text-white shadow-sm shadow-gray-50 text-sm py-1 rounded-md flex justify-center items-center w-full my-2 hover:bg-primary-600"
          >
            Moderation Panel
          </Link>
        )}
        ...
        {isModeratorUpdated && !isModeratorOfThisCommunity && (
          <button
            ...
            className="px-4 shadow-sm shadow-red-700 text-sm py-1 border border-red-500 hover:text-white hover:bg-red-400 text-red-400 rounded-md flex justify-center items-center w-full my-2"
          >
            Leave Community
          </button>
        )}
