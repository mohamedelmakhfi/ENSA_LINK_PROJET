...
const CommunityCard = ({ community }) => {
  ...
  return (
    <div className="px-3 py-3 rounded-md border bg-gray-800 shadow-2xl flex justify-between">
      <div className="w-full flex items-start">
        ...
        />
        <div className="">
          <h4 className="text-base font-semibold line-clamp-1 text-white">{community.name}</h4>
      ...
      <div className="">
        <button
          ...
          className="px-2.5 py-2.5 bg-primary shadow-2xl hover:bg-transparent group hover:border rounded-xl hover:border-primary transition duration-300"
        >
