    ...
    <>
      {loading || !user || !posts ? (
        ...
        <>
          ...
          <h3 className="font-semibold text-center mb-4 text-gray-300 p-3 border-b border-gray-600">
            Your most recent posts
          </h3>

          {postToShow?.length === 0 ? (
            <div className="text-center text-gray-300 flex justify-center items-center flex-col">
