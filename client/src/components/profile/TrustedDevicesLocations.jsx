...
const TrustedDevicesLocations = ({ trustedAuthContextData }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 p-5 bg-gray-800 rounded-md">
      <h2 className="text-lg font-medium text-white">Trusted Devices and Locations</h2>
      <div className="mt-6 border-t border-gray-600 pt-6">
        <div className="flow-root">
          <ul className="-my-5 divide-y divide-gray-600">
            {trustedDevices.length === 0 && (
              <span className="text-sm font-medium text-white">Not available</span>
            )}
