      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="flex w-full max-w-md transform flex-col items-center overflow-hidden rounded-md bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                  className="flex items-center gap-2 text-xl font-medium leading-6 text-blue-500"
                >
                  <IoIosPeople className="text-base text-blue-500 md:text-xl" />
                  <div className="relative">
                    {community.name}
                    <p className="absolute -right-4 -top-3 flex h-5 w-5 items-center justify-center rounded-full bg-blue-500 text-xs text-white">
                ...
                <div className="flex flex-col gap-2 px-4 py-3 sm:flex sm:px-6 md:flex-row md:gap-6">
                  <button
                    type="button"
                    className="inline-flex justify-center rounded-md border border-gray-300 bg-gray-700 px-4 py-2 text-base font-medium text-gray-300 shadow-sm hover:bg-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
                    onClick={onClose}
                    ref={cancelButtonRef}
                    disabled={loading}
                  >
