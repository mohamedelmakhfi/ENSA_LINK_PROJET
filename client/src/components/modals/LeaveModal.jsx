  ...
  return (
    <div className={`fixed inset-0 overflow-y-auto ${show ? "" : "hidden"}`}>
      <div className="flex min-h-screen items-center justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
        ...
        <div
          className="inline-block transform overflow-hidden rounded-md bg-gray-800 px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:align-middle z-50"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="mt-5 flex justify-center space-x-2 sm:mt-6">
            <button
              disabled={leaving}
              onClick={toggle}
              className="w-1/2 rounded-md border border-gray-300 bg-gray-700 px-4 py-2 text-base font-medium text-gray-300 shadow-sm hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:text-sm"
            >
              Cancel
            </button>
            <button
