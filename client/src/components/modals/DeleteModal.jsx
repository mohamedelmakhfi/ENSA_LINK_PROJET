      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-md bg-gray-800 text-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm">
                ...
                <div className="px-4 py-3 sm:flex sm:flex-row-reverse justify-center gap-5 sm:px-6">
                  ...
                  <button
                    disabled={loading}
                    type="button"
                    className="mt-3 inline-flex w-full border-dashed border justify-center rounded-md bg-white px-3  py-2 text-sm font-semibold text-gray-500 shadow-sm  hover:bg-gray-700 sm:mt-0 sm:w-auto"
                    onClick={() => {
                      onClose();
                    }}
                    ref={cancelButtonRef}
